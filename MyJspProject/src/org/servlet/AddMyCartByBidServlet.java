...
/**
 * Servlet implementation class AddMyCartByBidServlet
 */
@WebServlet("/AddMyCartByBidServlet")
public class AddMyCartByBidServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddMyCartByBidServlet() {
        super();
