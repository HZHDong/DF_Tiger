                ...
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i>
                            <%
                        		String name_first = (String)session.getAttribute("name_first");
                            	String name_second = (String)session.getAttribute("name_second");
                            	if(name_first==null)
                            		out.print("请先登录");
                            	else
                            		out.print(name_first+" "+name_second);
                            %>
...
<div class="copyrights">Collect from <a href="http://www.sucaiq.com/"  title="网站模板">网站模板</a></div>
        ...
        <div class="block-body">
            ...
            <p><a class="btn btn-primary btn-large">Learn more &raquo;</a></p>
                    ...
                    <footer>
                        ...
                        <p class="pull-right">Collect from <a href="http://www.sucaiq.com/" title="网页模板" target="_blank">网页模板</a></p>
